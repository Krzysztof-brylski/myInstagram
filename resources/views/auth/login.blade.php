...
<body>
<div class="container flex-column items-center justify-center">

    <div class="row">
        <div class="col-xl-6 flex" style="justify-content: right!important;" >
            <img src="img/login-page/phone.png">
        </div>
        <div class="col-xl-6 align-items-left py-3" >
