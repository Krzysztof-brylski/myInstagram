        ...
        <div className="modal-overlay">
            ...
            <div className="d-flex justify-content-center align-items-center h-100">
                <div className="content"  onClick={(event => {event.stopPropagation()})}>
                    ...
                    <div className="modal-form-container d-flex flex-column align-items-center justify-content-center" >
                        <svg aria-label="Ikona przedstawiająca multimedia takie jak obrazy lub filmy" className="_ab6-"
                        ...
                        <button className="form-submit my-2 w-25">Wybierz z komputera</button>
                    </div>
                </div>
            </div>
        </div>
